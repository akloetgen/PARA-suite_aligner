...
typedef struct {
	...
	int max_top2;
	int trim_qual;
	error_profile profile; //DAS KÖNNTE MAL EIN 51er ARRAY WERDEN UM POSITIONS-SPEZIFISCHE PROFILE ANZULEGEN!
	int X;
	double avg_match, avg_mm, best_mm;
